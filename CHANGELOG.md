...
- **A session that switched billing mid-life could stay held forever, instead of for
  ...
  climbed, so a frozen resume transient still cannot churn the retention cap. "Climbed" rather
  than "differs" so the gate agrees with what `hold` accepts as proof: it releases on
  `u > first_move`, so a slot spent on a counter that went down would buy evidence the release
  can never use.
...
[Unreleased]: https://github.com/Entrolution/quotaline/compare/v1.3.3...HEAD
[1.3.3]: https://github.com/Entrolution/quotaline/compare/v1.3.2...v1.3.3
[1.3.2]: https://github.com/Entrolution/quotaline/compare/v1.3.1...v1.3.2
